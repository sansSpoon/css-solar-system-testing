...
var module = function(){
	...
	const planets = hierarchy.selectAll('.hierarchy')
		.data(function(d, i) { return d.planets })
			.enter().append('div').classed("orbit", true).append('div').classed("planet", true)
