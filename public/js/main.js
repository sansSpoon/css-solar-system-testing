const d3System = function(){
	...
	const module = {},
				config = {
					ids:{
						...
						star: document.getElementById('starInput'),
					},
				},
	...
	let starfoo = data[0].hierarchies[0].star.radiusKM / config.ids.star.value;
	...
	config.ids.star.onchange = () => {
		console.log(config.ids.star.value);
		starfoo = data[0].hierarchies[0].star.radiusKM / config.ids.star.value;
		console.log(starfoo);
		_render(data);
	}
